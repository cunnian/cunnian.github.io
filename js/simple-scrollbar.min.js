(function(e, d) {
	function g(a) {
		a.hasOwnProperty("data-simple-scrollbar") || Object.defineProperty(a, "data-simple-scrollbar",
			new SimpleScrollbar(a))
	}
	...
	function f(a) {
		...
		for (this.wrapper.appendChild(this.el); this.target.firstChild;) this.el.appendChild(this.target
		.firstChild);
	...
	f.prototype = {
		moveBar: function(a) {
			...
			h(function() {
				1 === c.scrollRatio ? c.bar.classList.add("ss-hidden") : (c.bar.classList.remove(
						"ss-hidden"), c.bar.style.cssText = "height:" + 100 * c.scrollRatio +
					"%; top:" + c.el.scrollTop / b * 100 + "%;right:-" + (c.target.clientWidth -
						c.bar.clientWidth) + "px;")
			})
		}
	};
